...
class TomorrowScreen extends StatefulWidget{
  TomorrowPage createState()=> TomorrowPage();
}

class TomorrowPage extends State<TomorrowScreen> {
  bool started = false;
  String lat = '';
  String long = '';
  String temp = '--';
  ...
  getWeather() async {
    ...
    if (response.statusCode == 200) {
      ...
      var weatherTemp = tempList['daily'][1]['weather'][0]['description'];
      ...
      setState(() => {
        temp = tempList['daily'][1]['temp']['day'].round().toString(),
        weather = weatherTemp,
        icon = tempList['daily'][1]['weather'][0]['icon'].substring(0, 2 ),
        min = tempList['daily'][1]['temp']['min'].round().toString(),
        max = tempList['daily'][1]['temp']['max'].round().toString(),
        list = tempHourly
      });
